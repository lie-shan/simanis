...
class _DataPenggunaPageState extends State<DataPenggunaPage>
  ...
  List<_UserData> _siswaDummy = [
    _UserData(
      ...
      email: 'ahmad.fauzi@siswa.SIMANIS.id',
    ...
    _UserData(
      ...
      email: 'aisyah.putri@siswa.SIMANIS.id',
      password: 'password123',
    ...
    _UserData(
      ...
      email: 'budi.santoso@siswa.SIMANIS.id',
      password: 'password123',
      jenisKelamin: 'Laki-laki',
    ...
    _UserData(
      ...
      email: 'dewi.rahmawati@siswa.SIMANIS.id',
      password: 'password123',
      jenisKelamin: 'Perempuan',
    ...
    _UserData(
      ...
      email: 'farhan.maulana@siswa.SIMANIS.id',
      password: 'password123',
      jenisKelamin: 'Laki-laki',
    ...
    _UserData(
      ...
      email: 'gita.permatasari@siswa.SIMANIS.id',
      password: 'password123',
      jenisKelamin: 'Perempuan',
    ...
    _UserData(
      ...
      email: 'hendra.kusuma@siswa.SIMANIS.id',
      password: 'password123',
      jenisKelamin: 'Laki-laki',
    ...
    _UserData(
      ...
      email: 'indah.sari@siswa.SIMANIS.id',
      password: 'password123',
      jenisKelamin: 'Perempuan',
    ...
    _UserData(
      ...
      email: 'joko.widodo@siswa.SIMANIS.id',
      password: 'password123',
      jenisKelamin: 'Laki-laki',
    ...
    _UserData(
      ...
      email: 'kartika.dewi@siswa.SIMANIS.id',
      password: 'password123',
      jenisKelamin: 'Perempuan',
  ...
  final List<_UserData> _guruDummy = [
    _UserData(
      ...
      email: 'ahmad.fathoni@guru.SIMANIS.id',
      password: 'password123',
      jenisKelamin: 'Laki-laki',
    ...
    _UserData(
      ...
      email: 'siti.aminah@guru.SIMANIS.id',
      password: 'password123',
      jenisKelamin: 'Perempuan',
    ...
    _UserData(
      ...
      email: 'hafidz.mubarok@guru.SIMANIS.id',
      password: 'password123',
      jenisKelamin: 'Laki-laki',
    ...
    _UserData(
      ...
      email: 'budi.santoso@guru.SIMANIS.id',
      password: 'password123',
      jenisKelamin: 'Laki-laki',
